...
final class Gr_Secrets {
    ...
    /*
     * v1.2 integrations (ADR-0017): the same single vocabulary contract
     * as the pair groups above — the page that writes an option and
     * the client that reads it reference the constant, never the
     * literal, so the option key cannot drift between the two ends.
     */
    public const TURNSTILE_SITE_OPTION   = 'gr_secret_turnstile_site_key';
    public const TURNSTILE_SECRET_OPTION = 'gr_secret_turnstile_secret_key';
    public const HCAPTCHA_SITE_OPTION    = 'gr_secret_hcaptcha_site_key';
    public const HCAPTCHA_SECRET_OPTION  = 'gr_secret_hcaptcha_secret_key';
    public const ABUSEIPDB_KEY_OPTION    = 'gr_secret_abuseipdb_api_key';
    public const MATOMO_URL_OPTION       = 'gr_secret_matomo_instance_url';
    public const MATOMO_TOKEN_OPTION     = 'gr_secret_matomo_token_auth';
    public const MAXMIND_KEY_OPTION      = 'gr_secret_maxmind_license_key';
    public const TIKTOK_PIXEL_OPTION     = 'gr_secret_tiktok_pixel_code';
    public const TIKTOK_TOKEN_OPTION     = 'gr_secret_tiktok_access_token';

    /** Built-in native SMTP password (ADR-0019). */
    public const SMTP_PASS_OPTION = 'gr_secret_smtp_pass';
