...
use GreenPNG\Admin\Gr_Ecosystem_Page;
...
use GreenPNG\Integrations\Ecosystem\Gr_Dynamic_Sniffer;
...
use GreenPNG\Notification\Gr_Notification_Hub;
...
final class Gr_Plugin {
    ...
    private function register_hooks(): void {
        ...
        Gr_Spiders_Refresh::register();
        Gr_Maxmind_Refresh::register();
        Gr_Meta_Capi::register();
        Gr_Ga4_Mp::register();
        Gr_Matomo_Tracker::register();
        Gr_Tiktok_Capi::register();
        Gr_Webhook_Dispatcher::register();
        Gr_Smtp_Manager::register();
        Gr_Notification_Hub::register();
        ...
        Gr_Progressive_Verification::register_hooks();
        Gr_Abuseipdb::register();
        ...
        Gr_Ecosystem_Page::register_hooks();

        // Openness surface (docs/19 V32/V33): third-party adapters
        // ride the gr_registered_adapters filter with the same
        // probe-first lifecycle as the built-ins below; the dynamic
        // sniffer mounts owner rules in admin requests only, so
        // front-end traffic loads neither.
        Gr_Adapter_Registry::register();
        Gr_Dynamic_Sniffer::register_hooks();
