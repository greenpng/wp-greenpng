...
final class Gr_Admin_Menu {
    ...
    public static function register(): void {
        ...
        // Plugin Ecosystem (docs/06 tree) closes the Integrations
        // section: adapter posture, the owner's dynamic hook rules,
        // and the developer contract.
        add_submenu_page(
            self::SLUG,
            __( 'Plugin Ecosystem', 'greenpng' ),
            __( 'Plugin Ecosystem', 'greenpng' ),
            'manage_options',
            Gr_Ecosystem_Page::SLUG,
            array( Gr_Ecosystem_Page::class, 'render' )
        );
