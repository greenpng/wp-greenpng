...
| 13 | [v1.0 实施清单](13-v1-0-implementation-plan.md) | 92 项任务分解（v1.0 六阶段 + Phase 7 热修）、验收标准、进度真源、决议记录 | ✅（92 项全完，v1.0.0/v1.0.1 已发布） |
...
| 17 | [v1.1 实施清单](17-v1-1-implementation-plan.md) | v1.1 任务真源：九阶段 35 任务、悬置项裁定收口（G2/C5/G4/D8 等）、风险登记 | ✅（35 项全完，v1.1.0 已发布） |
